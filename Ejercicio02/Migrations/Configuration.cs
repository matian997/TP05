namespace Ejercicio02.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Ejercicio02.AccountManager.DAL.EntityFramework.AccountManagerDbContext>
    {
        ...
        protected override void Seed(AccountManager.DAL.EntityFramework.AccountManagerDbContext context)
        {
            ...
            {
                new AccountMovement { Id = 1, Description = "Compra en Aliexpress", Date = DateTime.Parse("27/10/2019"), Amount= 3400},
                new AccountMovement { Id = 2, Description = "Compra de celular", Date = DateTime.Parse("12/09/2019"), Amount= 28000.43},
                new AccountMovement { Id = 3, Description = "Compra en Banggood", Date = DateTime.Parse("20/09/2019"), Amount= 3420.20},
                new AccountMovement { Id = 4, Description = "Mantenimiento bancario", Date = DateTime.Parse("23/10/2019"), Amount= 300},
                new AccountMovement { Id = 5, Description = "Compra de zapatillas", Date = DateTime.Parse("06/11/2019"), Amount= 2032.99},
                new AccountMovement { Id = 6, Description = "Compra en MercadoLibre", Date = DateTime.Parse("12/08/2019"), Amount= 950},
                new AccountMovement { Id = 7, Description = "Impuesto por Compra en el extranjero", Date = DateTime.Parse("20/10/2019"), Amount= 1300}
            };
